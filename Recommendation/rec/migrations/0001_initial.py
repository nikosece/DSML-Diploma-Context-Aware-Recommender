# Generated by Django 3.1.3 on 2021-02-02 00:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preference', rec.models.ChoiceArrayField(base_field=models.CharField(choices=[('', '')], max_length=256), default=list, size=None)),
        ...
        migrations.AddField(
            model_name='business',
            name='icon',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='businesses', related_query_name='business', to='rec.businessicon'),
        ),
        migrations.AddField(
            model_name='business',
            name='photo',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rec.businessphoto'),
        ),
        migrations.AddField(
            model_name='business',
            name='price_level',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='businesses', related_query_name='business', to='rec.businessprice'),
        ),
    ]
